...
// admob-plugin.js, native-purchases-plugin.js, icons/) into
...
const files = ['index.html', 'manifest.json', 'sw.js', 'capacitor.js', 'admob-plugin.js', 'native-purchases-plugin.js'];
