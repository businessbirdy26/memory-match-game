/* Vendored from node_modules/@capgo/native-purchases/dist/plugin.js — this project has
   no JS bundler, so the plugin is included as a plain <script> instead of an ES import.
   Registers itself as window.Capacitor.Plugins.NativePurchases once loaded after
   capacitor.js. To update: bump @capgo/native-purchases in package.json, then re-copy
   that file over this one. */
